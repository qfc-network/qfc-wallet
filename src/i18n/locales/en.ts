...
export const en: Translations = {
  ...
  inference: {
    ...
    inputPlaceholder: 'Enter input text for inference',
    maxFeeLabel: 'Max Fee (QFC)',
    submit: 'Submit',
    submitting: 'Submitting...',
    submitSuccess: 'Task submitted! ID:',
  ...
  agents: {
    ...
    revoke: 'Revoke',
    revoked: 'Revoked',
    confirmRevoke: 'Are you sure you want to revoke this agent?',
    registering: 'Registering...',
    loadError: 'Failed to load agents',
    registerError: 'Failed to register agent',
    fundError: 'Failed to fund agent',
